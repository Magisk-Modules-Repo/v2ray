...
unzip -j -o "${ZIPFILE}" "v2ray/bin/$ARCH/dns2socks" -d $MODPATH/system/bin >&2
...
unzip -j -o "${ZIPFILE}" "v2ray/etc/dns2socks.conf" -d /data/v2ray >&2
...
echo "versionCode=20200814" >> $MODPATH/module.prop
...
set_perm  $MODPATH/scripts/dns2socks.service   0  0  0755
set_perm  $MODPATH/system/bin/dns2socks        0  0  0755
